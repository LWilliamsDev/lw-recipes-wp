...
The function that locks this block to the page post type is: function page_template in [Recipes\Blocks](../../../src/Blocks/Blocks.php).

## Child Blocks
- [Homepage Template](../home-template/readme.md)
- [Recipe Listing Template](../recipe-listing/readme.md)